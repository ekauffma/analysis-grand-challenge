# copied from https://gitlab.cern.ch/LHCb-Reco-Dev/pv-finder/-/blob/master/model/utilities.py
...
def Params(batch_size, epochs, lr, experiment_name, device, asymmetry_parameter=2.5,run_name = ''):
        return {'batch_size':batch_size, 'epochs':epochs, 'lr':lr, 'experiment_name':experiment_name, 'device':device, 'asymmetry_parameter':asymmetry_parameter, 'run_name': run_name}
